...
contract('Vester', function (accounts) {
	let root = accounts[0];
	...
	[
		...
		{T: 1262280, expectedPercentage: 0.0263187},
		{T: 20 * 24 * 3600, expectedPercentage: 0.035796},
		{T: 200 * 24 * 3600, expectedPercentage: 0.31019},
		{T: 500 * 24 * 3600, expectedPercentage: 0.61907},
		{T: 1450 * 24 * 3600, expectedPercentage: 0.99821},
