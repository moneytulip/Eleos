...
contract StakedLPToken01 is PoolToken {
    ...
    function _initialize(
        ...
        _WETH.safeApprove(address(_router), type(uint256).max);
        _underlying.safeApprove(address(_stakingRewards), type(uint256).max);
    }
        ...
        returns (uint256 redeemAmount)
    {
        ...
        require(
            ...
            "StakedLPToken01: INSUFFICIENT_CASH"
        );
    ...
    function _optimalDepositA(uint256 amountA, uint256 reserveA)
        internal
        pure
        returns (uint256)
    {
    ...
    function addLiquidity(
        ...
        (, , liquidity) = IUniswapV2Router01(router).addLiquidity(
            tokenA,
            tokenB,
            amountA,
            amountB,
        ...
        )
    {
        ...
        require(
            ...
            "StakedLPToken01: INSUFFICIENT_RESERVES"
        );
    }
